...
src_mtx = np.load('results/src_mtx.npy')
tgt_mtx = np.load('results/tgt_mtx.npy')
...
rep = np.load('results/representation.npy')
...
def make_data():
    ...
    return (
        torch.LongTensor(np.array(enc_inputs)),
        torch.LongTensor(np.array(dec_inputs)),
        torch.LongTensor(np.array(dec_outputs)),
        torch.LongTensor(np.array(u_inputs))
    )
